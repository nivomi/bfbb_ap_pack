...
ITEM_MAPPING = {
    ...
    [ITEM_BASE_ID + 010] = {"lvl_item_jf", "toggle"},
    [ITEM_BASE_ID + 011] = {"lvl_item_bb", "consumable"},
    [ITEM_BASE_ID + 012] = {"lvl_item_gl", "consumable"},
    [ITEM_BASE_ID + 013] = {"lvl_item_rb", "consumable"},
    [ITEM_BASE_ID + 014] = {"lvl_item_bc", "consumable"},
    [ITEM_BASE_ID + 015] = {"lvl_item_sm", "consumable"},
